...
class BikesControllerTest < ActionController::TestCase
  ...
  test "should create bike" do
    assert_difference('Bike.count') do
      post :create, bike: { color: @bike.color, description: @bike.description, image: @bike.image, manufacturer: @bike.manufacturer, name: @bike.name, price: @bike.price, type: @bike.type }
    end
  ...
  test "should update bike" do
    patch :update, id: @bike, bike: { color: @bike.color, description: @bike.description, image: @bike.image, manufacturer: @bike.manufacturer, name: @bike.name, price: @bike.price, type: @bike.type }
    assert_redirected_to bike_path(assigns(:bike))
  end
